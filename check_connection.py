...
def check_kafka():
    ...
    try:
        admin_client = KafkaAdminClient(bootstrap_servers=KAFKA_BOOTSTRAP_SERVERS, request_timeout_ms=5000)
    ...
    try:
        ...
        if not received:
            print("⚠️ Kafka Consumer: Kết nối được nhưng không tìm thấy tin nhắn vừa gửi.")
        consumer.close()
    except Exception as e:
