...
from adapters.database.mongodb_adapter import (
    get_mongodb_user_behavior,
    get_mongodb_product_store,
)
...
def reconstruct_sessions(
    interactions: List[Dict[str, Any]], session_gap_seconds: int = 1800
...
def evaluate_session_recommender():
    ...
    for session in test_sessions:
        ...
        recs = recommend_next_items(
            stats=stats, current_session_items=context_items, limit=20
        )
